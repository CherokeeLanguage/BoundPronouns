...
public class AwsPolly {
	...
	public static File generateEnglishAudio(VoiceId voice, String text) throws IOException {
		...
		AmazonPollyClientBuilder standard = AmazonPollyClientBuilder.standard();
		AmazonPolly client = standard.build();
